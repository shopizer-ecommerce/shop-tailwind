...
export default function Product() {
  ...
  **/
  ...
  /**
   * get from product friendly url
   */

  var pathArray = location.pathname.split('/');
  var friendlyUrl = pathArray[2];

  console.log('Current route ' + location.pathname + 'friendly url ' + friendlyUrl);
  ...
  const loadProduct = async () => {
    ...
    const productDetails = process.env.REACT_APP_SERVER_HOST + '/v2/product/slug/' + friendlyUrl + '?store=DEFAULT';
    axios({
      method: "GET",
      url: productDetails
    }).then((response) => {
